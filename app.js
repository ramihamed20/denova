...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      node_desc_community: 'A shared ground for students, educators and professionals to exchange perspective and move the profession forward.',
      node_desc_education: 'Advanced clinical workshops, hands-on training, and academic resources designed for continuous growth.',
      node_desc_research: 'A platform for publishing clinical cases, exchanging scientific evidence, and fostering evidence-based practice.',
      node_desc_innovation: 'Exploring digital dentistry, new technologies, and modern clinical methods shaping tomorrow.',
      node_desc_conference: 'The defining annual gathering in Tripoli connecting local talent with global dental leadership.',
      node_desc_partnerships: 'Strategic collaborations with universities, student unions, and educational academies.',
      eco_tag_1: '✦ Interactive',
      eco_tag_2: '✦ Academic',
      eco_tag_3: '✦ Evidence',
      eco_tag_4: '✦ Technology',
      eco_tag_5: '✦ Annual Event',
      eco_tag_6: '✦ Strategic',
      ...
      clinical_notify_btn: 'Coming Soon ↖',
      ...
      learning_notify_btn: 'Coming Soon ↖',
    ...
    ar: {
      ...
      node_desc_community: 'مساحة مشتركة تجمع الطلاب، الأكاديميين، والمهنيين لتبادل الآراء والارتقاء بمهنة طب الأسنان.',
      node_desc_education: 'ورش عمل سريرية متقدمة، تدريب عملي، وموارد أكاديمية صُممت للنمو المستمر.',
      node_desc_research: 'منصة لنشر الحالات السريرية، تبادل الأدلة العلمية، وتعزيز الممارسة القائمة على البراهين.',
      node_desc_innovation: 'استكشاف طب الأسنان الرقمي، التقنيات الحديثة، والأساليب السريرية المتطورة لرسم ملامح الغد.',
      node_desc_conference: 'الحدث العلمي السنوي الأبرز في طرابلس الذي يربط الكفاءات المحلية بالقيادات العالمية.',
      node_desc_partnerships: 'تعاون استراتيجي مثمر مع الجامعات، اتحادات الطلاب، والأكاديميات التعليمية.',
      eco_tag_1: '✦ تفاعلي',
      eco_tag_2: '✦ أكاديمي',
      eco_tag_3: '✦ أدلة علمية',
      eco_tag_4: '✦ تقنية',
      eco_tag_5: '✦ حدث سنوي',
      eco_tag_6: '✦ استراتيجي',
